...
<head>
    ...
    <style>
        ...
        .product__pagination .page-link {
            ...
            line-height: 44px;
            text-align: center;
            border-radius: 50%; /* Hình tròn đơn giản */
            border: none;
...
<script>
    const IS_LOGGED_IN = ${sessionScope.account != null};
</script>
                ...
                <div class="product__pagination">
                    <ul class="pagination justify-content-center">
                        <c:forEach begin="1" end="${endPage}" var="i">
                            <li class="page-item <c:if test="${(empty page && i == 1) || page == i}">active</c:if>">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('addToCartButton').addEventListener('click', function () {
            ...
            if (!IS_LOGGED_IN) {
                ...
                return; // ⛔ không gửi request, không chuyển trang
            }
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    ...
                    // ❌ SERVER BÁO CHƯA LOGIN (401)
                    else if (xhr.status === 401) {
                        showToast("Bạn cần đăng nhập trước khi mua hàng!", "warning");
                    }
                    // ❌ LỖI KHÁC
                    else {
